...
return [
    ...
    */
    ...
    'aliases' => Facade::defaultAliases()->merge([
        ...
        'HasSlug' => Spatie\Sluggable\HasSlug::class,
        'SlugOptions' => Spatie\Sluggable\SlugOptions::class,
        ...
        // 'Form' => Spatie\Html\Facades\Html::class, // Mapping the old name to the new tool
