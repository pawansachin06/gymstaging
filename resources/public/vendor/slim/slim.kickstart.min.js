    ...
    if (t)
        if (t.Slim = function() {
                ...
                var u = function() {
                    ...
                    l = function() {
                        ...
                        function i(t, e, i, r, s, h) {
                            var u, l, p, c, d, f, _, m, g, v, y, w, b, k, x, S, C, E, P, T, M, I, R, L, O = t.data,
                                z = h + h + 1,
                                D = r - 1,
                                A = s - 1,
                                H = h + 1,
                            ...
                            var j = o[h],
                                V = a[h];
                            for (l = 0; l < s; l++) {
                                for (S = C = E = P = m = g = v = y = 0, w = H * (T = O[f]), b = H * (M = O[f + 1]), k = H * (I = O[f + 2]), x = H * (R = O[f + 3]), m += U * T, g += U * M, v += U * I, y += U * R, N = B, p = 0; p < H; p++) N.r = T, N.g = M, N.b = I, N.a = R, N = N.next;
                                for (p = 1; p < H; p++) c = f + ((D < p ? D : p) << 2), m += (N.r = T = O[c]) * (L = H - p), g += (N.g = M = O[c + 1]) * L, v += (N.b = I = O[c + 2]) * L, y += (N.a = R = O[c + 3]) * L, S += T, C += M, E += I, P += R, N = N.next;
                                for (W = B, q = F, u = 0; u < r; u++) O[f + 3] = R = y * j >> V, 0 != R ? (R = 255 / R, O[f] = (m * j >> V) * R, O[f + 1] = (g * j >> V) * R, O[f + 2] = (v * j >> V) * R) : O[f] = O[f + 1] = O[f + 2] = 0, m -= w, g -= b, v -= k, y -= x, w -= W.r, b -= W.g, k -= W.b, x -= W.a, c = _ + ((c = u + h + 1) < D ? c : D) << 2, S += W.r = O[c], C += W.g = O[c + 1], E += W.b = O[c + 2], P += W.a = O[c + 3], m += S, g += C, v += E, y += P, W = W.next, w += T = q.r, b += M = q.g, k += I = q.b, x += R = q.a, S -= T, C -= M, E -= I, P -= R, q = q.next, f += 4;
                                _ += r
                            }
                            for (u = 0; u < r; u++) {
                                for (C = E = P = S = g = v = y = m = 0, f = u << 2, w = H * (T = O[f]), b = H * (M = O[f + 1]), k = H * (I = O[f + 2]), x = H * (R = O[f + 3]), m += U * T, g += U * M, v += U * I, y += U * R, N = B, p = 0; p < H; p++) N.r = T, N.g = M, N.b = I, N.a = R, N = N.next;
                                for (d = r, p = 1; p <= h; p++) f = d + u << 2, m += (N.r = T = O[f]) * (L = H - p), g += (N.g = M = O[f + 1]) * L, v += (N.b = I = O[f + 2]) * L, y += (N.a = R = O[f + 3]) * L, S += T, C += M, E += I, P += R, N = N.next, p < A && (d += r);
                                for (f = u, W = B, q = F, l = 0; l < s; l++) c = f << 2, O[c + 3] = R = y * j >> V, R > 0 ? (R = 255 / R, O[c] = (m * j >> V) * R, O[c + 1] = (g * j >> V) * R, O[c + 2] = (v * j >> V) * R) : O[c] = O[c + 1] = O[c + 2] = 0, m -= w, g -= b, v -= k, y -= x, w -= W.r, b -= W.g, k -= W.b, x -= W.a, c = u + ((c = l + H) < A ? c : A) * r << 2, m += S += W.r = O[c], g += C += W.g = O[c + 1], v += E += W.b = O[c + 2], y += P += W.a = O[c + 3], W = W.next, w += T = q.r, b += M = q.g, k += I = q.b, x += R = q.a, S -= T, C -= M, E -= I, P -= R, q = q.next, f += r
                            }
                            return t
                        }
                ...
                var p = function() {
                    ...
                    O = function(t, e, i, n, o, a) {
                        ...
                        n && r.upload.addEventListener("progress", function(t) {
                            n(t.loaded, t.total)
                        }), r.open("POST", t, !0), i && i(r, e), r.onreadystatechange = function() {
                            if (4 === r.readyState && r.status >= 200 && r.status < 300) {
                                ...
                                if ("object" === ("undefined" == typeof e ? "undefined" : c(e)) && "failure" === e.status) return void a(e.message);
                                o(e || t)
                                ...
                                if ("object" === ("undefined" == typeof n ? "undefined" : c(n)) && "failure" === n.status) return void a(n.message);
                                a("fail")
                            }
                        }, r.send(e)
                    },
                    ...
                    q = function(t) {
                        return "undefined" == typeof t.name ? W(new Date) + "." + U(j(t)) : t.name
                    },
                    j = function(t) {
                    ...
                    Z = function(t, e) {
                        ...
                        var r = wt(t);
                        return "undefined" == typeof e && (e = W(new Date) + "." + U(r)), G(K(n, r), e)
                    },
                    K = function(t, e) {
                    ...
                    yt = function(t, i, n) {
                        return t && i ? t.toDataURL(i, H(i) && "number" == typeof n ? n / 100 : e) : null
                    },
                    wt = function(t) {
                        if (!t) return null;
                    ...
                    It = function() {
                        var i = {
                            n: function(t, e, i, n) {
                                var o, a, r, s, h, u, l, p;
                                return r = t.y + t.height, o = R(e.y, 0, r), r - o < i.min.height && (o = r - i.min.height), h = n ? (r - o) / n : t.width, h < i.min.width && (h = i.min.width, o = r - h * n), l = .5 * (h - t.width), s = t.x - l, a = t.x + t.width + l, (s < 0 || a > i.width) && (p = Math.min(t.x, i.width - (t.x + t.width)), s = t.x - p, a = t.x + t.width + p, h = a - s, u = h * n, o = r - u), {
                                    x: s,
                                    y: o,
                                    width: a - s,
                                    height: r - o
                            ...
                            s: function(t, e, i, n) {
                                var o, a, r, s, h, u, l, p;
                                return o = t.y, r = R(e.y, o, i.height), r - o < i.min.height && (r = o + i.min.height), h = n ? (r - o) / n : t.width, h < i.min.width && (h = i.min.width, r = o + h * n), l = .5 * (h - t.width), s = t.x - l, a = t.x + t.width + l, (s < 0 || a > i.width) && (p = Math.min(t.x, i.width - (t.x + t.width)), s = t.x - p, a = t.x + t.width + p, h = a - s, u = h * n, r = o + u), {
                                    x: s,
                                    y: o,
                                    width: a - s,
                                    height: r - o
                            ...
                            e: function(t, e, i, n) {
                                var o, a, r, s, h, u, l, p;
                                return s = t.x, a = R(e.x, s, i.width), a - s < i.min.width && (a = s + i.min.width), u = n ? (a - s) * n : t.height, u < i.min.height && (u = i.min.height, a = s + u / n), l = .5 * (u - t.height), o = t.y - l, r = t.y + t.height + l, (o < 0 || r > i.height) && (p = Math.min(t.y, i.height - (t.y + t.height)), o = t.y - p, r = t.y + t.height + p, u = r - o, h = u / n, a = s + h), {
                                    x: s,
                                    y: o,
                                    width: a - s,
                                    height: r - o
                            ...
                            w: function n(t, e, i, o) {
                                var a, r, s, h, n, u, l, p;
                                return r = t.x + t.width, h = R(e.x, 0, r), r - h < i.min.width && (h = r - i.min.width), u = o ? (r - h) * o : t.height, u < i.min.height && (u = i.min.height, h = r - u / o), l = .5 * (u - t.height), a = t.y - l, s = t.y + t.height + l, (a < 0 || s > i.height) && (p = Math.min(t.y, i.height - (t.y + t.height)), a = t.y - p, s = t.y + t.height + p, u = s - a, n = u / o, h = r - n), {
                                    x: h,
                                    y: a,
                                    width: r - h,
                                    height: s - a
                            ...
                            ne: function(t, e, i, n) {
                                var o, a, r, s, h, u, l;
                                return s = t.x, r = t.y + t.height, a = R(e.x, s, i.width), a - s < i.min.width && (a = s + i.min.width), u = n ? (a - s) * n : R(r - e.y, i.min.height, r), u < i.min.height && (u = i.min.height, a = s + u / n), o = t.y - (u - t.height), (o < 0 || r > i.height) && (l = Math.min(t.y, i.height - (t.y + t.height)), o = t.y - l, u = r - o, h = u / n, a = s + h), {
                                    x: s,
                                    y: o,
                                    width: a - s,
                                    height: r - o
                            ...
                            se: function(t, e, i, n) {
                                var o, a, r, s, h, u, l;
                                return s = t.x, o = t.y, a = R(e.x, s, i.width), a - s < i.min.width && (a = s + i.min.width), u = n ? (a - s) * n : R(e.y - t.y, i.min.height, i.height - o), u < i.min.height && (u = i.min.height, a = s + u / n), r = t.y + t.height + (u - t.height), (o < 0 || r > i.height) && (l = Math.min(t.y, i.height - (t.y + t.height)), r = t.y + t.height + l, u = r - o, h = u / n, a = s + h), {
                                    x: s,
                                    y: o,
                                    width: a - s,
                                    height: r - o
                            ...
                            sw: function(t, e, i, n) {
                                var o, a, r, s, h, u, l;
                                return a = t.x + t.width, o = t.y, s = R(e.x, 0, a), a - s < i.min.width && (s = a - i.min.width), u = n ? (a - s) * n : R(e.y - t.y, i.min.height, i.height - o), u < i.min.height && (u = i.min.height, s = a - u / n), r = t.y + t.height + (u - t.height), (o < 0 || r > i.height) && (l = Math.min(t.y, i.height - (t.y + t.height)), r = t.y + t.height + l, u = r - o, h = u / n, s = a - h), {
                                    x: s,
                                    y: o,
                                    width: a - s,
                                    height: r - o
                            ...
                            nw: function(t, e, i, n) {
                                var o, a, r, s, h, u, l;
                                return a = t.x + t.width, r = t.y + t.height, s = R(e.x, 0, a), a - s < i.min.width && (s = a - i.min.width), u = n ? (a - s) * n : R(r - e.y, i.min.height, r), u < i.min.height && (u = i.min.height, s = a - u / n), o = t.y - (u - t.height), (o < 0 || r > i.height) && (l = Math.min(t.y, i.height - (t.y + t.height)), o = t.y - l, u = r - o, h = u / n, s = a - h), {
                                    x: s,
                                    y: o,
                                    width: a - s,
                                    height: r - o
                        ...
                        return function() {
                            ...
                            return p(n, [{
                                ...
                                value: function(t, e, i, n) {
                                    this._interaction = null, this._rect = {
                                        x: R(t, 0, this._space.width - this._minWidth),
                                        y: R(e, 0, this._space.height - this._minHeight),
                                        width: R(i, this._minWidth, this._space.width),
                                        height: R(n, this._minHeight, this._space.height)
                                    }, this._rectChanged = !0, this._redraw(), this._element.dispatchEvent(new CustomEvent("change"))
                                }
                            }, {
                                key: "handleEvent",
                                ...
                                value: function(t) {
                                    ...
                                    "c" === n ? (this._rect.x = R(e.x - this._interaction.offset.x, 0, this._space.width - this._rect.width), this._rect.y = R(e.y - this._interaction.offset.y, 0, this._space.height - this._rect.height)) : i[n] && (this._rect = i[n](this._rect, {
                                        x: e.x - this._space.x,
                                        y: e.y - this._space.y
                                    }, {
                                        x: 0,
                                ...
                                key: "destroy",
                                value: function() {
                                    this._interaction = !1, this._rectChanged = !1, S(document, y.DOWN, this), S(document, y.MOVE, this), S(document, y.UP, this), Ct(this._element)
                                }
                            }, {
                                key: "element",
                                get: function() {
                        ...
                        var i = ["input", "change"],
                            n = function() {
                                ...
                                return p(n, [{
                                    ...
                                    value: function() {
                                        var t = this;
                                        this._element.className = "slim-image-editor", this._container = k("div", "slim-container"), this._wrapper = k("div", "slim-wrapper"), this._stage = k("div", "slim-stage"), this._container.appendChild(this._stage), this._cropper = new It, i.forEach(function(e) {
                                    ...
                                    value: function() {
                                        ...
                                        e && E(e, 90), this._updateWrapperScale(), this._hideCropper(), u(this._previewWrapper, {
                                    ...
                                    value: function(t, e, i, n, o) {
                                        ...
                                        }, this._preview.src = "", this._preview.src = ht(this._input, Math.min(this._container.offsetWidth / this._input.width, this._container.offsetHeight / this._input.height)).toDataURL()
                                    }
                                }, {
                                    key: "_redrawCropper",
                                    value: function(t) {
                                    ...
                                    value: function() {
                                        ...
                                        }), this._cropper.destroy(), this._element.parentNode && Ct(this._element)
                                    }
                                }, {
                            ...
                            return p(n, [{
                                ...
                                value: function(t) {
                                    ...
                                    return null === e || e ? (this._dragPath || (this._dragPath = []), this._dragPath.push(m(t)), void this._element.dispatchEvent(new CustomEvent("file-over", {
                                        detail: {
                                            x: I(this._dragPath).x,
                                            y: I(this._dragPath).y
                                        }
                                ...
                                value: function() {
                                    ...
                                    }), Ct(this._element), this._element = null, this._dragPath = null, this._accept = null
                                }
                            }, {
                                key: "element",
                                get: function() {
                    ...
                    Ht = ["x", "y", "width", "height"],
                    Ut = ["file-invalid-drop", "file-invalid", "file-drop", "file-over", "file-out", "click"],
                    Bt = ["cancel", "confirm"],
                    ...
                    Gt = function() {
                        ...
                        return p(i, [{
                            ...
                            value: function() {
                                ...
                                if (this._isImageOnly()) o.innerHTML = "\n\t\t\t\t" + qt + "\n\t\t\t\t" + jt + "\n\t\t\t\t" + h + '\n\t\t\t\t<div class="slim-status"><div class="slim-label-loading">' + (this._options.labelLoading || "") + "</div></div>\n\t\t\t";
                                    ...
                                    this._input.hasAttribute("accept") && "image/*" !== this._input.getAttribute("accept") ? u = this._input.accept.split(",").map(function(t) {
                                        ...
                                        return t.length > 0
                                    }) : (u = A(), this._input.setAttribute("accept", u.join(","))), this._imageHopper = new Lt, this._imageHopper.accept = u, this._imageHopper.allowURLs = "string" == typeof this._options.fetcher, this._element.appendChild(this._imageHopper.element), Ut.forEach(function(e) {
                            ...
                            value: function(t) {
                                if (t = Math.min(.99999, t), this._element && this._progressEnabled) {
                                    ...
                                    if (e) {
                                        ...
                                        n[0].setAttribute("d", Mt(.5 * i, .5 * i, .5 * i - o, .9999)), n[1].setAttribute("d", Mt(.5 * i, .5 * i, .5 * i - o, t))
                                    }
                                }
                            }
                        }, {
                            ...
                            key: "_onInvalidFile",
                            value: function() {
                                var t = this._imageHopper.accept.map(U),
                            ...
                            value: function(t, e, i, n) {
                                ...
                                if (n || (n = {}), !this._isBeingDestroyed) {
                                    ...
                                    this._isFixedRatio() || (this._initialCrop ? this._ratio = this._initialCrop.height / this._initialCrop.width : this._ratio = a ? t.width / t.height : t.height / t.width, this._scaleDropArea(this._ratio)), this._initialCrop ? (this._data.actions.crop = mt(this._initialCrop), this._data.actions.crop.type = At.INITIAL, this._initialCrop = null) : (this._data.actions.crop = tt(a ? t.height : t.width, a ? t.width : t.height, this._ratio), this._data.actions.crop.type = At.AUTO), this._options.size && (this._data.actions.size = {
                                        ...
                                        }, s), a.src = "", a.src = ht(t, r).toDataURL(), a.onload = function() {
                            ...
                            value: function() {
                                var t = this;
                                this._imageEditor || (this._imageEditor = new Rt(k("div"), {
                            ...
                            value: function() {
                                var t = arguments.length > 0 && arguments[0] !== e ? arguments[0] : function(t) {},
                                    ...
                                    n = tt(i ? this._data.input.image.width : this._data.input.image.height, i ? this._data.input.image.height : this._data.input.image.width, this._ratio);
                            ...
                            value: function(t, e) {
                                ...
                                this.requestOutput(function(t, n) {
                                    ...
                                    "string" == typeof i._options.service ? O(i._options.service, n, a, r, s, h) : "function" == typeof i._options.service && i._options.service.apply(i, ["file" === i._options.serviceFormat ? t : n, r, s, h])
                                }, t)
                            }
                        }, {
                            key: "requestOutput",
                            ...
                            value: function() {
                                ...
                                this._isBeingDestroyed = !0, this._timers.forEach(function(t) {
                                    clearTimeout(t)
                                }), this._timers = [], u(this._element, "detach"), this._imageHopper && (Ut.forEach(function(t) {
                            ...
                            value: function() {
                                ...
                                return Nt.concat(Rt.Buttons).concat("rotate").forEach(function(e) {
                                    var i = M(e);
                ...
                return function() {
                    ...
                    Nt.concat(Rt.Buttons).concat("rotate").forEach(function(t) {
                        var e = M(t);
                        ...
                        var e, i, n, o = [];
                        for (e = t.querySelectorAll(".slim:not([data-state])"),
                                 n = e.length; n--;) i = e[n], o.push(Gt.create(i, Gt.getOptionsFromAttributes(i)));
                        return o
                        ...
                        for (var n in e) {
                            var o = f[n],
                                a = e[n];
                            o ? (a = o(a), a = null === a ? mt(Gt.options()[n]) : a, i[n] = a) : 0 === n.indexOf("meta") && (i.meta[T(n.substr(4))] = a)
                        }
                        return i
                    }, Gt.find = function(t) {
