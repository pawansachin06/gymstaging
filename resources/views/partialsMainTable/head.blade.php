...
<link href="{{ asset('/gymselect/styles/style.css?v=1.0.0') }}" rel="stylesheet" type="text/css">
<link href="{{ asset('/gymselect/styles/responsive.css?v=1.0.0') }}" rel="stylesheet" type="text/css">
