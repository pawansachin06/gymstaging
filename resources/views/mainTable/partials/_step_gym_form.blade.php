<div class="col-12 col-md-12 col-lg-12 col-xl-12 mx-auto" id="gym-step4">
...
@endif--}}
    ...
    <div class="form-section text-center">
        <div class="form-group">
            <label>Address </label>
            <p>Let our users know where they can find you.</p>
            <div class="row">
                <div class="col-12 col-md-12 col-lg-6 col-xl-6">
                    <div class="mb-3">
    ...
    <div class="form-section media-cont text-center">
        <div class="form-group">
            <label>Media </label>
            <p>Add photos of your facility. Show potential members what they can expect when they
                arrive.</p>
    ...
    <div class="form-section hours about text-center">
        <div class="form-group">
            ...
            <p>Edit opening hours or select 24 hours if you are a 24 hour facility.</p>
                    ...
                    <ul>
                        <li>
                            <div class="time-hours">
                                <p>&nbsp;</p>
                                <div class="time-hours1">&nbsp;</div>
                                <div class="custom-control custom-checkbox"> Closed</div>
                            </div>
                        </li>
                        @foreach(\App\Http\Helpers\AppHelper::weekdays() as $key => $day)
                            <li>
                                <div class="time-hours">
                                    <p>{{$day}}</p>
    ...
    <div class="form-section hours about text-center">
        <div class="form-group">
            ...
            <p class="mb-0">Enter your membership options</p>
                ...
                <div class="col-12 col-md-6  col-lg-6 col-xl-6 mt-4 pr-0 append-section " data-uid="{{$random_id}}">
                    <div class="new-options-container">
                        ...
                        <div class="member-plan">
                            <input class="form-control" placeholder="Option Name e.g. Day Pass" name="membership_options[{{$random_id}}][name]" type="text">
                        </div>
                        <div class="member-plan">
                            <input class="form-control" placeholder="Price e.g.  7" name="membership_options[{{$random_id}}][price]" type="text">
                        </div>
                        <div class='member-includes'>
                            <div class="btn btn2 btn-block include-heading">What does this include?</div>
                            <div class="member-includes-list">
                                <ul>
                                    <li class="append-section">
                                        <input class="form-control plan-includes" placeholder="e.g. Full gym access" name="membership_options[{{$random_id}}][includes][]" type="text">
    ...
    <div class="form-section hours about text-center meet-team">
        <div class="form-group">
            <label>Meet the Team</label>
            <p class="text-left">Upload members of your team. If any of your team have GymSelect Profile, you can tag them below so that users can click and view their profile.</p>
            <div class="row row-eq-height">
                <div class="col-12 col-md-6 col-lg-3 col-xl-3 upload-team">
                    <div class="wrapper">
                        <div class="file-upload media  user-upload" id="upload-holder-team">
                            <button type="button" class="btn btn2 btn-block btn-team">
                                <i class="fas fa-plus" aria-hidden="true"></i>
                            </button>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-6 col-lg-3 col-xl-3 append-section">
                    <div class="team-profile">
                        <div class="wrapper  gym-team-thumb">
                            <div class="file-upload profilephoto" id="upload-holder">
                                <input id="file_path" name="team[file_path][]" type="file">
                                <i class="fas fa-4x fa-user" aria-hidden="true"></i>
                            </div>
                        </div>
                        <div class="form-group member-input">
                            <input type="text" name="team[name][]" class="form-control" placeholder="Name">
                        </div>
                        <div class="form-group member-top member-input">
                            <input type="text" class="form-control" name="team[job][]" placeholder="Job Title">
                        </div>
                        <div class="form-group member-top mar-o member-input">
                            <input type="text" class="form-control iconAutoComplete" placeholder="@profile" data-url="{{ route('autosearch.listing',['icon','val'=>'user_id']) }}"
                                   autocomplete="off">
    ...
    <div class="form-section hours about text-center">
        <div class="form-group">
            ...
            <p>If you have a class timetable, upload it so potential members can see what you offer.</p>
            <div class="row row-eq-height timetable-cont">
...
<div class="row">
    <div class="col-12 col-md-12 col-lg-10 col-xl-6 offset-xl-3 mt-4">
        <button type="button" class="btn btn2 btn-dark btn-block border-radius" id="save_listing"
