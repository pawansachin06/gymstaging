                ...
                <div class="comments">
                        ...
                        <div class="user-right">
                            <div class="">
                                @if($review->brand == 'G' || $review->brand == 'G API')
                                    <img src="{{ asset('/images/google.png')  }}" alt=" " class="review-mobile-icon">
                                @elseif($review->brand == 'F' || $review->brand == 'F API')
                                    <img src="{{ asset('/images/Facebook.png')  }}" alt=" " class="review-mobile-icon">
                                @else
                                    <img src="{{ asset('/images/IMG_0585.PNG')  }}" alt=" " class="review-mobile-icon">
                                @endif
                                {{-- {!!$review->reviewStars!!} --}}
                            </div>
                        </div>
                    ...
                    <div class="report-abuse w-100 d-flex">
                        <div class="comments-section">
                            <small class="comments-weeks">{{\Carbon\Carbon::parse($review->created_at)->diffForHumans()}}</small>
                            @if(auth()->check())
                                @if($listing->canReply())
                                ...
                                <div class="comments">
                                    ...
                                    <div class="user-texts">
                                        ...
                                        @if(auth()->check())
                                            @if($reply->canReply())
                                                <span class="comments-edit">
                                                <a href="#" onclick="openCommentsForm({{$reply['id']}},0)">
                                                    <i class="fas fa-pencil-alt"></i>
                                                </a>
                                            </span>
                                            @endif
