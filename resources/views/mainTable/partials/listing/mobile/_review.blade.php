...
<div class="col-12 col-md-12 col-lg-12 col-xl-12 mobile-section">
    ...
    <div class="list-comments" id="showcomment">
        ...
        {{ html()->form('POST', route('listings.reviewstore', $listing->slug))->id('reviewForm')->attributes(['autocomplete' => 'off', 'style' => 'display:none'])->open() }}
        <div class="panel panel-default tab-content">
            <div class="panel-body">
                <div class="row  star-field">
                    <div class="col-xs-12 form-group">
                        {{ html()->label('ratings', trans('quickadmin.listings.fields.ratings'))->class('control-label') }}
                ...
                <div class="row">
                    <div class="col-xs-12 form-group">
                        {{ html()->label('message', trans('quickadmin.listings.fields.message'))->class('control-label') }}
