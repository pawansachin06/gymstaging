            ...
            <div class="row">
                <div class="col-12 col-md-12 col-lg-6 col-xl-6">
                    ...
                    <div class="form-group city">
                        {!! Form::text('address[city]', old('address.city',@$address->city), ['class' => 'form-control','placeholder'=>'*Enter City','id'=> 'city']) !!}
                    </div>
                    <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="wrapper">
                <div class="file-upload media" id="upload-holder-result">
                    {{ Form::file('result[]',['id'=>'result','multiple'=>true])}}
                    <i class="fas fa-plus" aria-hidden="true"></i></div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-12 col-md-12 col-lg-6 col-xl-6 offset-xl-3 p-0  upload-qualification">
                    <div class="form-group">
                        ...
                        {!! Form::text('qualification_options[name][]', old('qualification_options[name][]',null), ['class' => 'form-control','placeholder'=>'e.g. Level 3 Personal Trainer']) !!}
                    </div>
                </div>
