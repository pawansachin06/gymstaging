<div class="col-12 col-md-12 col-lg-12 col-xl-12 mx-auto" id="physio-step4">
    ...
    <div class="form-section text-center">
        <div class="form-group">
            ...
            <div class="col-12 offset col-md-6 offset-md-6 col-lg-4 offset-lg-4 col-xl-4 offset-xl-4">
...
<div class="form-section text-center">
        <div class="form-group">
        <label>*Address </label>
        <p>Let users know where they can find you.</p>
        <div class="row">
            <div class="col-12 col-md-12 col-lg-6 col-xl-6">
                <div class="mb-3">
...
<div class="form-section features-list accordion">
    <div class="form-group">
        ...
        <p>Check all the treatments you offer.</p>
        <ul>
...
<div class="form-section media-cont text-center">
    <div class="form-group">
        <label>Media </label>
        <p>Upload images that will showcase what you do. We recommend images of you working with clients.
        </p>
    ...
    <div class="form-group">
        ...
        <div class="row">
            <div class="col-12 col-md-12 col-lg-6 col-xl-6 offset-xl-3 p-0  upload-qualification">
                <div class="form-group">
                    {{-- <p> <input type="text" class="form-control" placeholder="e.g. BSc Physiotherapy"> </p> --}}
                    {{ html()->text('qualification_options[name][]', old('qualification_options[name][]', null))->class('form-control')->placeholder('e.g. BSc Physiotherapy') }}
                </div>
            </div>
            <div class="col-12 col-md-12 col-lg-6 col-xl-6 offset-xl-3">
                <div class="form-group">
                    {{-- <p> <input type="text" class="form-control" placeholder="e.g. BSc Physiotherapy"> </p> --}}
                    <div class="form-group" id="qualification-options"></div>
                    <button type="button" class="btn btn2 btn-block btn-qualification" onclick=""><i class="fas fa-plus" aria-hidden="true"></i></button>
                </div>
            </div>
        </div>
    </div>
...
<div class="form-section hours about text-center">
    <div class="form-group">
        ...
        <p class="mb-0">Enter your options below.</p>
         <p style="color:red;float:center;">*Leave blank if you do not wish to show your prices.</p>
            ...
            <div class="col-12 col-md-6  col-lg-6 col-xl-6 mt-4 pr-0 append-section" data-uid="{{$random_id}}">
                <div class="new-options-container">
                    ...
                    <div class="member-plan">
                        <input class="form-control" placeholder="Name e.g. 1 Hour Massage" name="membership_options[{{$random_id}}][name]" type="text">
                    </div>
                    <div class="member-plan">
                        <input class="form-control" placeholder="Price e.g. £40" name="membership_options[{{$random_id}}][price]" type="text">
                    </div>
                    <div class='member-includes'>
                        <div class="btn btn2 btn-block">What are the benefits?</div>
                        <div class="member-includes-list">
                            <ul>
                                <li class="append-section">
                                    <input class="form-control plan-includes" placeholder="e.g. Reduced muscle tension" name="membership_options[{{$random_id}}][includes][]" type="text">
