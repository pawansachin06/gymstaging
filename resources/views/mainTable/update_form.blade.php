                    ...
                    <form method="POST" action="{{ route('user.updateprofile') }}" enctype="multipart/form-data">
                        ...
                        <fieldset class="pb-5">
                            <div class="col-12 col-md-12 col-lg-6 col-xl-6 mx-auto">
                                <p>
                                    {{ html()->text('name', old('name', $user->name))->class('form-control')->placeholder('Name')->required() }}
                                </p>
                                <p>
                                    {{ html()->email('email', old('email', $user->email))->class('form-control')->placeholder('Email')->required() }}
                                </p>
                                <p>
