...
@section('content')
    <h3 class="page-title">{{ $business->name }} @lang('quickadmin.businesses.title') @lang('quickadmin.listings.title')</h3>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body table-responsive">
            ...
            <a href="{{ route('admin.businesses.index') }}"
               class="btn btn-default">@lang('quickadmin.qa_back_to_listing')</a>
        </div>
    </div>
@stop
