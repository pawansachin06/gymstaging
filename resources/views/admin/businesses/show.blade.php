            ...
            @foreach ($listings as $listing)
                <tr data-entry-id="{{ $listing->id }}">
                    <td field-key='name'>{{ $listing->name }}</td>
                                ...
                                <td field-key='logo'>@if($listing->logo)<a href="{{ $listing->getUrl('logo') }}" target="_blank">
...
{!! Form::open(array(
        ...
        @endif
            ...
            <a href="{{ route('admin.businesses.index') }}" class="btn btn-default">@lang('quickadmin.qa_back_to_listing')</a>
        </div>
    </div>
@stop
