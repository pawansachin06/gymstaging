...
<a href="{{ route('admin.pcoupon.index') }}" class="btn btn-default"  style= "float:right">Back To Coupons</a>
    ...
    {{ html()->form('POST', route('admin.pcoupon.store'))->open() }}
        ...
        <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-xs-6 form-group">
                            ...
                            {{ html()->select('type', \App\Models\Couponproducts::$types, old('type'))->class('form-control') }}
                            <p class="help-block"></p>
                        </div>
                        <div class="col-xs-6 form-group">
                    ...
                    <div class="row">
                        <div class="col-xs-6 form-group">
                            ...
                            {{ html()->number('maximum_redemptions', old('maximum_redemptions'))->class('form-control')->placeholder('') }}
                            <p class="help-block"></p>
                    ...
                    <div class="row">
                        <div class="col-xs-12 form-group">
                            ...
                            {{ html()->multiselect('product_id[]', $products, old('product_id'))->class('form-control select2') }}
                            <p class="help-block"></p>
