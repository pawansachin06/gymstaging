@props(['user' => null])
<header class="position-relative bg-white shadow">
    <div class="container py-1">
        <div class="row gx-1 justify-content-between align-items-center">
            <div class="col-auto">
                <button class="btn px-2 py-2 rounded-circle border-light" type="button" data-bs-toggle="offcanvas" data-bs-target="#menu-offcanvas" aria-controls="menu-offcanvas">
            ...
            <div class="col-auto">
                @auth
                    <button class="btn px-1 py-1 rounded-circle border-light" type="button" data-bs-toggle="offcanvas" data-bs-target="#user-offcanvas" aria-controls="user-offcanvas">
                        <img src="{{ $user->profile_image }}" alt="{{ $user->name }}" width="36" height="36" class="rounded-circle user-select-none" />
                    </button>
                @else
                    <button class="btn px-2 py-2 rounded-circle border-light" type="button" data-bs-toggle="offcanvas" data-bs-target="#user-offcanvas" aria-controls="user-offcanvas">
                        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" viewBox="0 -960 960 960">
