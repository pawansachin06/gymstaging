...
<div x-bind:class="[completedSteps.includes('timetable') ? 'active' : '']"
    ...
    <h2 class="accordion-header">
        <button class="accordion-button z-1 px-3 py-2 shadow-none bg-transparent collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-timetable" aria-expanded="false" aria-controls="collapse-timetable">
