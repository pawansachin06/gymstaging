...
<div x-bind:class="[completedSteps.includes('about') ? 'active' : '']"
    ...
    <div id="collapse-about" class="accordion-collapse collapse" data-bs-parent="#accordion-listing">
        <div class="accordion-body">
            <textarea id="item-about" x-on:input.debounce.1000ms="checkStep('about')" name="about" rows="5" placeholder="Enter description..." class="form-control">{{ $item->about }}</textarea>
        </div>
    </div>
</div>