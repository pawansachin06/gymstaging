...
<article x-data="page" class="container">
    ...
    <div class="my-4 rounded-3 bg-white shadow-md overflow-hidden">
                ...
                <div id="my-data-container" class="d-flex flex-column flex-grow-1">
                    <div class="px-2 py-2">
                        ...
                        <div x-show="placeSuggestions.length == 0">
                            <p data-css="map-input-example" class="mt-1 mb-0">
    ...
    <div x-show="drafts.length > 0" x-cloak class="my-4 px-3 py-3 rounded-3 bg-white shadow-md">
        <h2 class="h4 mb-2 font-weight-bold">Selected Boost Locations</h2>
